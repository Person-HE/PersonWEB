...
export const resourceConfig: CrudConfig<Resource> = {
  ...
  fields: [
    ...
    { key: 'productUrl', label: '产品链接（个人产品类）', type: 'url', full: true },
    { key: 'downloadUrl', label: '下载链接（教程/AI资料类）', type: 'url', full: true },
...
export const serviceConfig: CrudConfig<Service> = {
  ...
  fields: [
    ...
    { key: 'type', label: '类型', type: 'select', options: ['tool-config', 'ai-output', 'custom', 'product-pro', 'product', 'automation', 'skills', 'enterprise'] as ServiceType[], required: true },
